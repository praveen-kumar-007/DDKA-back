...
const sanitizeFilename = (value) =>
  String(value || "official")
    .replace(/[^a-zA-Z0-9_-]+/g, "_")
    .replace(/_+/g, "_")
    .replace(/^_|_$/g, "") || "official";

const createOfficialPdfBuffer = (official, assetType) =>
  new Promise((resolve, reject) => {
    ...
    const title = isIdCard
      ? "DDKA Technical Official ID Card"
      : "DDKA Technical Official Certificate";

    doc.font("Helvetica-Bold").fontSize(20).text(title, { align: "center" });
    doc.moveDown(0.35);
    doc.font("Helvetica").fontSize(11).text("Dhanbad District Kabaddi Association", {
      align: "center",
    });
    doc.moveDown(1.2);
    ...
    const rows = [
      ...
      ["Blood Group", official.bloodGroup || "NA"],
      [
        "Date of Birth",
        official.dob ? new Date(official.dob).toISOString().slice(0, 10) : "-",
      ],
    ...
    doc
      ...
      .text(
        isIdCard
          ? "This is an official ID document generated by DDKA backend records."
          : "This certificate is generated by DDKA backend records.",
      );
    doc.moveDown(1.2);
    doc
      .font("Helvetica")
      ...
      .text("Source: DDKA Backend Database");
